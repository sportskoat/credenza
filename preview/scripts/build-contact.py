...
<html lang="en">
  ...
  <body>
    ...
    <main>
      <p class="mail"><a href="mailto:wenselllc@gmail.com">wenselllc@gmail.com</a></p>
      ...
      <p>
        Same address. Say which one in the subject line. Credenza is agent
        agnostic on purpose: the preferred agent is a user setting, and stored
        links stay canonical marketplace URLs until the moment somebody opens
        Buy. We do not rank agents for payment, and we do not accept placement
        in the app. <a href="/guides/choose-an-agent/">Choose an agent</a>
        explains the comparison the app actually makes.
      </p>
