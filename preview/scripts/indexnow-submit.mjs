...
const urls = [
  ...
  `${base}/faq/`,
  `${base}/guides/`,
  `${base}/guides/organize-agent-haul/`,
  `${base}/guides/spreadsheet-vs-haul-planner/`,
  `${base}/guides/reddit-haul-to-list/`,
  `${base}/guides/weidian-size-chart/`,
  `${base}/guides/open-weidian-in-agent/`,
  `${base}/privacy/`,
  `${base}/terms/`,
  `${base}/llms.txt`,
  `${base}/llms-full.txt`,
